...
public class Cities {
	...
	public static void main(String[] args) {
		...
		System.out.println(anotherCity.hashCode());//Another object from object class is 
		//hashCode(). it always returns an int
		//it is mostly used by HashSet, HashMap, HashTable sata structures
		//to efficiently look up an elements, and manipulate them
		//HASHING --> is like giving a unique ID for a group of objects.
		//it is always an int by default
