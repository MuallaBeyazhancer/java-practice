...
public class EtsyAccount {
	...
	//costructor 2. 
	//takes 3-args and set them to instance variables using setters;
	...
	public void setEmail(String email) {
		...
		//if not show message "Please enter a valid email."
	...
	private boolean isValidFirstName(String firstName) {
		//check first if it starts with or endsWith space
		//return false
